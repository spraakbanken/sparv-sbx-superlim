...
__config__ = [
    ...
    Config("sbx_superlim.stats.contains_words", [], description="Batch size for inference. Required with large files and limited CPU/GPU memory."),
    Config("sbx_superlim.stats.source_files_spans", {}, description="Spans of the source files to analyze.")
]
